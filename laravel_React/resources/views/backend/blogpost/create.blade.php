					...
					<form method="post" action="{{route('blogpost.store')}}" enctype="multipart/form-data">
						...
						<label class="col-sm-12 col-md-2 col-form-label">Post Name</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Enter Event Post Name" name="post_name" value="{{old('post_name')}}">
							</div>
						</div>
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2 col-form-label">Event Location</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" type="text" placeholder="Enter Event Location" name="location" value="{{old('location')}}">
                                    </div>
                                </div>
