        ...
        <div class="about-image-box">
            <div class="row d-flex align-items-center justify-content-between">
                ...
                <div class="col-lg-7 ps-4">
                    <div class="about-features" style="background-image:url({{asset('frontend/assets/images/contentbg.png')}});">
                        <div class="row align-items-center">
                            <div class="col-lg-6 mb-4">
                                <img src="{{asset('frontend/assets/images/about/busi-3.jpg')}}" alt="">
                            </div>
                            <div class="col-lg-6">
                                <img src="{{asset('frontend/assets/images/about/busi-1.jpg')}}" alt="" class="mb-4">
...
<!-- about-us starts -->
<section class="about-us about-features pt-12 pb-8" style="background-image:url({{asset('frontend/assets/images/testimonial-1.png')}});">
    <div class="container">
        <div class="about-image-box">
            <div class="row d-flex align-items-center justify-content-between">
...
<!-- our teams starts -->
<section class="event-team pt-2" style="background-image: url({{asset('frontend/assets/images/manbg.png')}});">
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 ps-lg-5">
                <div class="testimonial-image">
                    <img src="{{asset('frontend/assets/images/testi-image.png')}}" alt="" class="opacity-50">
                </div>
            </div>
        </div>
    </div>
